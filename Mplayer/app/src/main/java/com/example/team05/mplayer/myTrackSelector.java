...
/**
 * Created by lanyi on 30/10/2017.
 */

public class myTrackSelector extends MappingTrackSelector {
    /**
    ...
    public static final class Parameters {
        ...
        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance with the provided preferred language for audio and
         * forced text tracks.
         *
         ...
         * @return A {@link DefaultTrackSelector.Parameters} instance with the provided preferred language for audio and
         *     forced text tracks.
         */
        public myTrackSelector.Parameters withPreferredAudioLanguage(String preferredAudioLanguage) {
            ...
            return new myTrackSelector.Parameters(preferredAudioLanguage, preferredTextLanguage,
        ...
        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance with the provided preferred language for text tracks.
         *
         ...
         * @return A {@link DefaultTrackSelector.Parameters} instance with the provided preferred language for text tracks.
         */
        public myTrackSelector.Parameters withPreferredTextLanguage(String preferredTextLanguage) {
        ...
        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance with the provided mixed mime adaptiveness allowance.
         *
         * @param allowMixedMimeAdaptiveness Whether to allow selections to contain mixed mime types.
         * @return A {@link DefaultTrackSelector.Parameters} instance with the provided mixed mime adaptiveness allowance.
         */
        public myTrackSelector.Parameters withAllowMixedMimeAdaptiveness(boolean allowMixedMimeAdaptiveness) {
        ...
        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance with the provided seamless adaptiveness allowance.
         *
         * @param allowNonSeamlessAdaptiveness Whether non-seamless adaptation is allowed.
         * @return A {@link DefaultTrackSelector.Parameters} instance with the provided seamless adaptiveness allowance.
         */
        public myTrackSelector.Parameters withAllowNonSeamlessAdaptiveness(boolean allowNonSeamlessAdaptiveness) {
        ...
        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance with the provided max video size.
         *
         * @param maxVideoWidth The max video width.
         * @param maxVideoHeight The max video width.
         * @return A {@link DefaultTrackSelector.Parameters} instance with the provided max video size.
         */
        public myTrackSelector.Parameters withMaxVideoSize(int maxVideoWidth, int maxVideoHeight) {
        ...
        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance with the provided max video bitrate.
         *
         * @param maxVideoBitrate The max video bitrate.
         * @return A {@link DefaultTrackSelector.Parameters} instance with the provided max video bitrate.
         */
        public myTrackSelector.Parameters withMaxVideoBitrate(int maxVideoBitrate) {
         ...
         *
         * @return A {@link DefaultTrackSelector.Parameters} instance with maximum standard definition as maximum video size.
         */
        public myTrackSelector.Parameters withMaxVideoSizeSd() {
         ...
         *
         * @return A {@link DefaultTrackSelector.Parameters} instance without video size constraints.
         */
        public myTrackSelector.Parameters withoutVideoSizeConstraints() {
            return withMaxVideoSize(Integer.MAX_VALUE, Integer.MAX_VALUE);
        }

        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance with the provided
         * {@code exceedVideoConstraintsIfNecessary} value.
         *
         * @param exceedVideoConstraintsIfNecessary Whether to exceed video constraints when no
         *     selection can be made otherwise.
         * @return A {@link DefaultTrackSelector.Parameters} instance with the provided
         *     {@code exceedVideoConstraintsIfNecessary} value.
         */
        public myTrackSelector.Parameters withExceedVideoConstraintsIfNecessary(
         ...
         *     {@code exceedRendererCapabilitiesIfNecessary} value.
         */
        public myTrackSelector.Parameters withExceedRendererCapabilitiesIfNecessary(
        ...
        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance with the provided viewport size.
         *
         * @param viewportWidth Viewport width in pixels.
         * @param viewportHeight Viewport height in pixels.
         * @param orientationMayChange Whether orientation may change during playback.
         * @return A {@link DefaultTrackSelector.Parameters} instance with the provided viewport size.
         */
        public myTrackSelector.Parameters withViewportSize(int viewportWidth, int viewportHeight,
        ...
        /**
         * Returns a {@link DefaultTrackSelector.Parameters} instance where the viewport size is obtained from the provided
         * {@link Context}.
         *
         * @param context The context to obtain the viewport size from.
         * @param orientationMayChange Whether orientation may change during playback.
         * @return A {@link DefaultTrackSelector.Parameters} instance where the viewport size is obtained from the provided
         *     {@link Context}.
         */
        public myTrackSelector.Parameters withViewportSizeFromContext(Context context, boolean orientationMayChange) {
         ...
         *
         * @return A {@link DefaultTrackSelector.Parameters} instance without viewport size constraints.
         */
        public myTrackSelector.Parameters withoutViewportSizeConstraints() {
        ...
        public boolean equals(Object obj) {
            ...
            myTrackSelector.Parameters other = (myTrackSelector.Parameters) obj;
    ...
    private final AtomicReference<myTrackSelector.Parameters> paramsReference;
    ...
    public myTrackSelector(TrackSelection.Factory adaptiveTrackSelectionFactory) {
        ...
        paramsReference = new AtomicReference<>(new myTrackSelector.Parameters());
    }
     ...
     */
    public void setParameters(myTrackSelector.Parameters params) {
     ...
     */
    public myTrackSelector.Parameters getParameters() {
    ...
    protected TrackSelection[] selectTracks(RendererCapabilities[] rendererCapabilities,
        ...
        myTrackSelector.Parameters params = paramsReference.get();
    ...
    private static int[] getAdaptiveAudioTracks(TrackGroup group, int[] formatSupport,
        ...
        myTrackSelector.AudioConfigurationTuple selectedConfiguration = null;
        HashSet<myTrackSelector.AudioConfigurationTuple> seenConfigurationTuples = new HashSet<>();
        for (int i = 0; i < group.length; i++) {
            Format format = group.getFormat(i);
            myTrackSelector.AudioConfigurationTuple configuration = new myTrackSelector.AudioConfigurationTuple(
    ...
    private static int getAdaptiveAudioTrackCount(TrackGroup group, int[] formatSupport,
                                                  myTrackSelector.AudioConfigurationTuple configuration) {
        int count = 0;
        for (int i = 0; i < group.length; i++) {
    ...
    private static final class AudioConfigurationTuple {
        ...
        public boolean equals(Object obj) {
            ...
            myTrackSelector.AudioConfigurationTuple other = (myTrackSelector.AudioConfigurationTuple) obj;
